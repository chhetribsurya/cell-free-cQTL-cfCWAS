...
# base_dir <- "/path/to/workspace/NewTest_cfChIP-WBC_peaks_H3K4me3Enrich_V2"
base_dir <- "/path/to/workspace/NewTest_cfChIP-WBC_peaks_H3K4me3Enrich_V2"  # Update this to your actual path
