...
# GWAS significance data - GCST90320055
gwas_data <- fread('Data/RCC.GCST90320055.GWAS.chr8.sumstats.txt')
gwas_data$base_pair_location = gwas_data$start_hg19
gwas_data <- gwas_data %>%
...
MNLP_gr <- GRanges(
  seqnames = 8,             # Chromosome
  ranges = IRanges(start = 128889370, end = 128889370),  # SNP positions
...
# Plot the tracks
pdf(
  paste0("Manuscripts/Figures/1_g_raw.pdf"),
