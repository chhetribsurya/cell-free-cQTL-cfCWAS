...
meta.data = read_excel('~/Projects/cfChIP/Data/Sample_information/meta_data.xlsx') 
k27.cfCWAS.sample = read.table('~/Projects/cfChIP/Data/Sample_information/cfChIP_H3K27ac_samples.txt', header = T)
k4.cfCWAS.sample = read.table('~/Projects/cfChIP/Data/Sample_information/cfChIP_H3K4me3_samples.txt', header = T)
